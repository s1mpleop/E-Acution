...
public class SellerController {
	...
	@PutMapping("/{sellerId}")
	public ResponseEntity<SellerDto> updateUser(@RequestBody SellerDto sellerDto, @PathVariable Long sellerId){
		SellerDto updatedUser = this.sellerService.updateUser(sellerDto, sellerId);
